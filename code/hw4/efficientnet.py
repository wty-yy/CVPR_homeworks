...
# 模型导入
model = Sequential([
    hub.KerasLayer("https://tfhub.dev/tensorflow/efficientnet/lite4/classification/2", input_shape=(224, 224, 3)),
...
checkpoint_path = "checkpoint/efficientnet_dropout.ckpt"
...
tb_callback = keras.callbacks.TensorBoard(log_dir="logs/efficientnet_dropout", histogram_freq=1)
