...
GT_PATH = os.path.join(parent_path, 'data', 'TestImages', 'ground-truth')
DR_PATH = os.path.join(parent_path, 'data', 'TestImages', 'detection-results')
# if there are no images then no animation can be shown
IMG_PATH = os.path.join(os.getcwd(), 'object-detector-master', 'data', 'TestImages', 'images-optional')
